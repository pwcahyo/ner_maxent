...
gaz_o = ["demam", "berdarah", "dengue", "dbd", "db"]
...
gaz_org = ["pemkot", "dinkes", "pemda", "pemkab", "dinas", "pemerintah", "rs", "dprd", "kecamatan", "kabupaten", "kota", "desa", "pemdes", "kab","who", "puskesmas","korpri","kelurahan", "provinsi", "menkes","pmi","kab", "klinik"]
#"kabupaten", 
